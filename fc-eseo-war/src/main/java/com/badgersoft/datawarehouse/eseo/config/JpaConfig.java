...
@Configuration
@EnableJpaRepositories(basePackages = "com.badgersoft.datawarehouse.eseo.dao")
...
public class JpaConfig {
    ...
    public DataSource dataSource() throws NamingException {
        return (DataSource) new JndiTemplate().lookup("fcdw/eseo");
    }
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
        ...
        em.setPackagesToScan(new String[] { "com.badgersoft.datawarehouse.eseo"});
