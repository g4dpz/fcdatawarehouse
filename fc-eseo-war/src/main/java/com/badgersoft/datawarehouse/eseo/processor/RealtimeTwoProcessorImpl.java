...
import com.badgersoft.datawarehouse.eseo.dao.RealtimeTwoDao;
 ...
 */
public class RealtimeTwoProcessorImpl extends AbstractProcessor implements RealtimeProcessor {



    private static final Logger LOGGER = LoggerFactory.getLogger(RealtimeTwoProcessorImpl.class);

    private static AtomicLong channelValue = new AtomicLong(0L);

    @Autowired
    RealtimeTwoDao realtimeTwoDAO;
    ...
    public void process(HexFrameDTO hexFrameDTO) throws Exception {
        ...
        RealtimeTwoEntity realtimeEntity = new RealtimeTwoEntity();
        ...
        realtimeTwoDAO.save(realtimeEntity);
