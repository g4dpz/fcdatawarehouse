...
@Configuration
@EnableJpaRepositories(basePackages = "com.badgersoft.datawarehouse.nayif1.dao")
...
public class JpaConfig {
    ...
    public DataSource dataSource() throws NamingException {
        return (DataSource) new JndiTemplate().lookup("fcdw/nayif1");
    }
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
        ...
        em.setPackagesToScan(new String[] { "com.badgersoft.datawarehouse.nayif1"});
