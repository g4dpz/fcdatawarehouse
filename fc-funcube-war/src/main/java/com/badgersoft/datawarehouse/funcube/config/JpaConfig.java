...
@Configuration
@EnableJpaRepositories(basePackages = "com.badgersoft.datawarehouse.funcube.dao")
...
public class JpaConfig {
    ...
    public DataSource dataSource() throws NamingException {
        return (DataSource) new JndiTemplate().lookup("fcdw/funcube1");
    }
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
        ...
        em.setPackagesToScan(new String[] { "com.badgersoft.datawarehouse.funcube"});
